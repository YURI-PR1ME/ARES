...
void LCD_Write(bit style, unsigned char input)
{
	LcdEn=0;
	LcdRs=style;
	LcdRw=0;		_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();
	DBPort=input;	_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();//注意顺序
	LcdEn=1;		_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();_nop_();//注意顺序
